...
import Five from "./assets/5-chip.png";
import TwentyFive from "./assets/25-chip.png";
import OneHundred from "./assets/100-chip.png";
import FiveHundred from "./assets/500-chip.png";
import OneThousand from "./assets/1000-chip.png";
import TenThousand from "./assets/10k-chip.png";
import FiftyThousand from "./assets/50k-chip.png";
import OneHundredK from "./assets/100k-chip.png";
import FiveHundredK from "./assets/500k-chip.png";
import OneMillion from "./assets/1m-chip.png";
...
const App = () => {
  ...
  const handleSubmitScore = () => {
    const max = Math.max(...highscore); //Find the maximum value in the array(array will contain only values of the object)
  if(score > max){
    if(score !== 0){
    ...
    const sorted = [...highscore].sort((a, b) => {
      return a - b;
    });
    setSorted(sorted);
  }
  ...
  useEffect(() => {
    localStorage.setItem('highscore', JSON.stringify(sorted));
  }, [sorted])
  ...
  //These are about payouts, losses and pushes
  useEffect(() => {
    if (winner === "dealer") {
      setBetAmount(0);
    }
  ...
  return (
    <div className="app">
      <header className="app-header">
        <p className="title">♠ Play BlackJack!♡</p>
        <div className="pending-bet">
          ...
          <div className="scoreboard">
            <p>Your score is currently: {score} </p>
            <p>Top Highscore is:{highscore}</p>
          </div>
        </div>
